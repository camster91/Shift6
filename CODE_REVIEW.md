...
```
storePassword=Shift6Ashbi2026!
keyPassword=Shift6Ashbi2026!
```

**android/app/build.gradle:23-25:**
```
storePassword 'shift6release2024'
keyPassword 'shift6release2024'
```
...
`keystore.properties` has `Shift6Ashbi2026!` while `build.gradle` has `shift6release2024` — unclear which is actually used. This suggests the build.gradle values may be stale/unused.
