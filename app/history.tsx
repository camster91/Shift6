...
export default function HistoryScreen() {
  ...
  const currentEntries = previewEnabled ? demoWorkoutHistory : entries;
  const visibleEntries = useMemo(
    () => currentEntries.filter((entry) => filter === 'all' || entry.status === filter),
    ...
    return (
      <Screen>
        <ErrorState
          ...
          message="Local training storage is unavailable. Reopen the app to restore your saved workout history."
        />
  ...
  return (
    <Screen>
      ...
      {previewEnabled ? (
        <Card tone="yellow" accessibilityLabel="Development workout history preview">
          <Text variant="small" tone="muted">
            Development preview: these sample sessions are not your saved workout history.
          </Text>
        </Card>
      ) : null}
