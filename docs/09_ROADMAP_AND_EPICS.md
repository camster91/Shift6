...
Local workout reminders now reconcile a bounded seven-day one-shot schedule from the active program snapshot and preferred training window after explicit device permission. Stable SHIFT6-owned identifiers are cancelled before replacement, and notification payloads carry a workout deep-link without mutating plan data. Remote push, review/rest-timer scheduling, exact alarm editing, background delivery guarantees, response routing, and native device verification remain open #280/#281 work.
