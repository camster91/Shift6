...
7. Run the focused-release gate for every referenced enabled exercise. Run the 300-record catalogue assessment separately when pursuing the future breadth target.
