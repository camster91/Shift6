...
**Run date:** 2026-06-06
**Round:** 1 of 3
**Output:** `~/Shift6/docs/tester-reports/tester-1-hannah-round1.md`
...
Write to `~/Shift6/docs/tester-reports/tester-1-hannah-round1.md`:

```
# Home Hero Hannah — Round 1
...
## Round 1 — Happy path (Hannah, ~30 min)

You are a first-time user. You have never seen this app.

1. **Land on the app.** Open https://getshift6.com. What do you see? Is the first screen welcoming or confusing?
2. **Onboarding.** Complete the onboarding. Don't read all the text — just tap what feels right. You don't have a gym membership, so you do home workouts. You have a pull-up bar and a resistance band.
3. **Dashboard.** Land on the dashboard. What's the first thing you see? Is it clear what to do next? Is there a "Start workout" button or do you have to look for it?
4. **Try to start today's workout.** Find the Start button. Tap it. What happens?
5. **Do the workout — but as Hannah would.** You don't have a barbell. If the app says "Heavy Squats" with a barbell, what do you do? If you see a plate visualizer showing a bar, do you know what to do with it?
6. **Log a set.** The app probably wants weight + reps. You don't track weight on push-ups. How do you log a bodyweight exercise?
7. **Check Progress.** After the workout (or if you can't finish one, just navigate there), look at the Progress tab. Is there anything? If it's empty, what does it say? Is it encouraging or deflating?
8. **Open Settings.** Find the 1RM editor. Try to set a 1RM for the first exercise. What happens?
9. **Open Account.** What do you see? Is it a sign-in screen? Do you care? Will you sign in?
10. **Try to sign out or close the app.** Where's the sign-out button? Or is there one?
...
Write the report to `~/Shift6/docs/tester-reports/tester-1-hannah-round1.md`.

Then output a one-line summary in your final response:

```
WROTE: ~/Shift6/docs/tester-reports/tester-1-hannah-round1.md — <one-line summary of top finding>
```
