...
(async () => {
  ...
  await page.evaluate(() => {
    const data = {
      userProfile: { displayName: 'Cam', estimated1RMs: { bench_press: 185, incline_bench: 165, lateral_raise: 25, tricep_pushdown: 100 }, onboardedAt: '2026-06-01' },
  ...
  await page.screenshot({ path: '/tmp/dashboard-bench-vp.png', fullPage: false });
  console.log('saved');
  await browser.close();
})();