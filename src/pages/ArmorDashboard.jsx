...
function HabitCheck({ habit, done, onToggle }) {
  return (
    <button
      onClick={onToggle}
      aria-pressed={done}
      className={`armor-press w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all focus-visible:ring-2 focus-visible:ring-emerald-500/50 outline-none ${
        done
          ? 'bg-emerald-500/8'
