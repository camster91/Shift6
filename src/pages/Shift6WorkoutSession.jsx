    ...
    if (this.state.hasError) {
      return (
        <div className="flex flex-col flex-1 px-6 pt-4 text-center max-w-sm mx-auto w-full items-center justify-center space-y-4 p-4">
          <p className="text-[var(--text-secondary)] text-sm font-bold">Something went wrong.</p>
          <p className="text-[var(--text-tertiary)] text-xs">An unexpected technical error occurred in this set. Details have been logged for the developer.</p>
          <button
